...
impl LlmProviderCatalog {
    pub fn new(has_api_key: bool, id: String, models: Vec<models::LlmCatalogModel>, name: String, requires_api_key: bool, requires_base_url: bool, status: models::LlmProviderCatalogStatus) -> LlmProviderCatalog {
        LlmProviderCatalog {
            base_url: None,
            error: None,
            has_api_key,
