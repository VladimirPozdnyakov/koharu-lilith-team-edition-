...
impl PipelineProgress {
    pub fn new(current_page: u32, current_step_index: u32, job_id: String, overall_percent: u32, status: models::PipelineStatus, total_pages: u32, total_steps: u32) -> PipelineProgress {
        PipelineProgress {
            current_page,
            current_step_index,
            job_id,
