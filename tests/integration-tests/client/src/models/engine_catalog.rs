...
impl EngineCatalog {
    pub fn new(bubble_segmenters: Vec<models::EngineCatalogEntry>, detectors: Vec<models::EngineCatalogEntry>, font_detectors: Vec<models::EngineCatalogEntry>, inpainters: Vec<models::EngineCatalogEntry>, ocr: Vec<models::EngineCatalogEntry>, renderers: Vec<models::EngineCatalogEntry>, segmenters: Vec<models::EngineCatalogEntry>, translators: Vec<models::EngineCatalogEntry>) -> EngineCatalog {
        EngineCatalog {
            bubble_segmenters,
            detectors,
            font_detectors,
