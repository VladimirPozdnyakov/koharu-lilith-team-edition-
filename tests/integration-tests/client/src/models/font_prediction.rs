...
impl FontPrediction {
    pub fn new(angle_deg: f32, direction: models::TextDirection, font_size_px: f32, line_height: f32, named_fonts: Vec<models::NamedFontPrediction>, stroke_color: Vec<u32>, stroke_width_px: f32, text_color: Vec<u32>, top_fonts: Vec<models::TopFont>) -> FontPrediction {
        FontPrediction {
            angle_deg,
            direction,
            font_size_px,
