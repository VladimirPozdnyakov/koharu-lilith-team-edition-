...
impl AppEventOneOf1 {
    pub fn new(current_page: i32, current_step_index: i32, job_id: String, overall_percent: i32, status: models::PipelineStatus, total_pages: i32, total_steps: i32, event: Event) -> AppEventOneOf1 {
        AppEventOneOf1 {
            current_page,
            current_step_index,
            job_id,
