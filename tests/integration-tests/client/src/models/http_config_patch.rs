...
pub struct HttpConfigPatch {
    #[serde(rename = "connectTimeout", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "readTimeout", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
