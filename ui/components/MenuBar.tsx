  ...
  const exportItems: MenuItem[] = [
    {
      label: t("menu.export"),
      onSelect: () =>
        void exportCurrentProjectAs("rendered", [requirePageId()]),
      disabled: !hasPage,
  ...
  return (
    <div className="flex h-8 items-center border-b border-border bg-background text-[13px] text-foreground">
      ...
      <div className="flex h-full items-center pl-2 select-none">
        <Image
          src="/icon.png"
          alt="Koharu (Lilith Team Edition)"
          width={18}
          height={18}
          draggable={false}
        />
          ...
          >
            ...
            {exportItems.map((item) => (
              <MenubarItem
                ...
                onSelect={
                  item.onSelect ? () => void item.onSelect?.() : undefined
                }
              >
                {item.label}
              </MenubarItem>
        ...
        <MenubarMenu>
          ...
          >
            ...
            >
              {t("menu.undo")}
              <MenubarShortcut>
                {formatShortcutForDisplay(shortcuts.undo, isMac)}
              </MenubarShortcut>
            </MenubarItem>
            <MenubarItem
            ...
            >
              {t("menu.redo")}
              <MenubarShortcut>
                {formatShortcutForDisplay(shortcuts.redo, isMac)}
              </MenubarShortcut>
            </MenubarItem>
            <MenubarSeparator />
            <MenubarItem
        ...
        <MenubarMenu>
          ...
          >
            ...
            <MenubarItem
              ...
              onSelect={() =>
                void runCustomPipeline({ pageId: requirePageId() })
              }
            >
              ...
              <MenubarSubContent className="min-w-48">
                <MenubarCheckboxItem
                  ...
                  onCheckedChange={(checked) =>
                    setCustomPipeline({ detect: checked })
                  }
                ...
                <MenubarCheckboxItem
                  ...
                  onCheckedChange={(checked) =>
                    setCustomPipeline({ translator: checked })
                  }
                  onSelect={(e) => e.preventDefault()}
                >
                  {t("llm.generate")}
                ...
                <MenubarCheckboxItem
                  ...
                  onCheckedChange={(checked) =>
                    setCustomPipeline({ inpainter: checked })
                  }
                  onSelect={(e) => e.preventDefault()}
                >
                  {t("mask.inpaint")}
                ...
                <MenubarCheckboxItem
                  ...
                  onCheckedChange={(checked) =>
                    setCustomPipeline({ renderer: checked })
                  }
                  onSelect={(e) => e.preventDefault()}
                >
                  {t("llm.render")}
